...
export default function Property2() {
  ...
  const property = propertiesData.properties.find((p) => p.id === "prop2");
  const [activeTab, setActiveTab] = useState("overview");
  const [selectedImage, setSelectedImage] = useState("/property2/p1.jpeg"); // Default large image
  // List of images
  const images = [
      "/property2/p1.jpeg",
      "/property2/p2.jpeg",
  ...
  return (
    <div>
      ...
      <div id="googleMap" className="py-4">
        ...
        <iframe
          title="Google Map"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9934.735498440912!2d-0.1277582165102296!3d51.50721732515695!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761cb113b24035%3A0x30a2ab0a10a539d4!2sLondon%2C%20UK!5e0!3m2!1sen!2sus!4v1695682828930!5m2!1sen!2sus"
          width="100%"
          height="300"
