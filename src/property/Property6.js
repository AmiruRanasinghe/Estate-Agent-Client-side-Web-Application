...
export default function Property6() {

  const navigate = useNavigate();
  const property = propertiesData.properties.find((p) => p.id === "prop6");
  const [activeTab, setActiveTab] = useState("overview");
  const [selectedImage, setSelectedImage] = useState("/property6/p1.jpeg"); // Default large image
  // List of images
  const images = [
      "/property6/p1.jpeg",
      "/property6/p2.jpeg",
  ...
  return (
    <div>
      ...
      <div id="googleMap" className="py-4">
        ...
        <iframe
          title="Google Map"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9821.50586931869!2d-1.2577264164761098!3d51.752013783180936!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4876c6a8c62a9b15%3A0x4729fcb5f30d8c1d!2sOxford%2C%20UK!5e0!3m2!1sen!2sus!4v1695682828930!5m2!1sen!2sus"
          width="100%"
          height="300"
