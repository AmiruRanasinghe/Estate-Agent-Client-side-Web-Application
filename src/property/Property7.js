...
export default function Property7() {

  const navigate = useNavigate();
  const property = propertiesData.properties.find((p) => p.id === "prop7");
  const [activeTab, setActiveTab] = useState("overview");
  const [selectedImage, setSelectedImage] = useState("/property7/p1.jpeg"); // Default large image
  // List of images
  const images = [
      "/property7/p1.jpeg",
      "/property7/p2.jpeg",
  ...
  return (
    <div>
      ...
      <div id="googleMap" className="py-4">
        ...
        <iframe
          title="Google Map"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9477.566487737096!2d0.12181711649857526!3d52.205337185779716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d87b9f303622b1%3A0x3e5d5c62744a4694!2sCambridge%2C%20UK!5e0!3m2!1sen!2sus!4v1695682828930!5m2!1sen!2sus"
          width="100%"
          height="300"
